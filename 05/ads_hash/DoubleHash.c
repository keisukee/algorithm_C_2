...
int hash   (Key v, int M)  {return  v%M;}
int hashtwo(Key v, int M)  {return  (v%97)+1;}
...
void STprintSearchAverageFail(Key* allkeys, int N){
  ...
  printf("(==>) ANSER FOR DOUBLE HASH (Fail) : %f\n\n", (double)average/20);
}
